;;
;; Copyright 2013 Martin Kielhorn <kielhorn.martin@gmail.com>
...
;; will need clozure common lisp and a foreign function database for
;; the egl headers. this is generated by placing the following contents into the file ccl/arm-headers/raspberry-pi-vc/C/populate.sh: 

;; #!/bin/sh
;; CFLAGS="-I/usr/include/arm-linux-gnuabihf/";export CFLAGS
;; rm -rf opt
;; h-to-ffi.sh -I/usr/include/arm-linux-gnueabihf -I/opt/vc/include  -I/opt/vc/include/interface/vcos/pthreads /opt/vc/include/EGL/egl.h
;; h-to-ffi.sh -I/usr/include/arm-linux-gnueabihf -I/opt/vc/include  -I/opt/vc/include/interface/vcos/pthreads -I/opt/vc/include/interface/vmcs_host/linux /opt/vc/include/bcm_host.h
;; h-to-ffi.sh -I/usr/include/arm-linux-gnueabihf -I/opt/vc/include  /opt/vc/include/GLES/gl.h
;; h-to-ffi.sh -I/usr/include/arm-linux-gnueabihf -I/opt/vc/include  /opt/vc/include/GLES/glplatform.h
;; h-to-ffi.sh -I/usr/include/arm-linux-gnueabihf -I/opt/vc/include  /opt/vc/include/GLES2/gl2.h
;; h-to-ffi.sh -I/usr/include/arm-linux-gnueabihf -I/opt/vc/include  /opt/vc/include/GLES2/gl2platform.h
;; h-to-ffi.sh -I/usr/include/arm-linux-gnueabihf -I/opt/vc/include -I/opt/vc/include/interface/vcos/pthreads   /opt/vc/include/EGL/eglplatform.h
...
;; the foreign functions available. note that this requires ffigen4, a
;; version of gcc that parses c and header files and outputs
;; s-expressions (ffi files).
...
;; alternatively, you can obtain the database, that i prepared:

;; pi@raspberrypi ~/raspberry-pi-egl-test $ find ~/ccl/arm-headers/raspberry-pi-vc/
;; /home/pi/ccl/arm-headers/raspberry-pi-vc/
;; /home/pi/ccl/arm-headers/raspberry-pi-vc/vars.cdb
;; /home/pi/ccl/arm-headers/raspberry-pi-vc/records.cdb
;; /home/pi/ccl/arm-headers/raspberry-pi-vc/C
;; /home/pi/ccl/arm-headers/raspberry-pi-vc/C/opt
;; /home/pi/ccl/arm-headers/raspberry-pi-vc/C/opt/vc
;; /home/pi/ccl/arm-headers/raspberry-pi-vc/C/opt/vc/include
;; /home/pi/ccl/arm-headers/raspberry-pi-vc/C/opt/vc/include/GLES
;; /home/pi/ccl/arm-headers/raspberry-pi-vc/C/opt/vc/include/GLES/gl.ffi
;; /home/pi/ccl/arm-headers/raspberry-pi-vc/C/opt/vc/include/GLES/glplatform.ffi
;; /home/pi/ccl/arm-headers/raspberry-pi-vc/C/opt/vc/include/EGL
;; /home/pi/ccl/arm-headers/raspberry-pi-vc/C/opt/vc/include/EGL/eglplatform.ffi
;; /home/pi/ccl/arm-headers/raspberry-pi-vc/C/opt/vc/include/EGL/egl.ffi
;; /home/pi/ccl/arm-headers/raspberry-pi-vc/C/opt/vc/include/bcm_host.ffi
;; /home/pi/ccl/arm-headers/raspberry-pi-vc/C/opt/vc/include/GLES2
;; /home/pi/ccl/arm-headers/raspberry-pi-vc/C/opt/vc/include/GLES2/gl2.ffi
;; /home/pi/ccl/arm-headers/raspberry-pi-vc/C/opt/vc/include/GLES2/gl2platform.ffi
;; /home/pi/ccl/arm-headers/raspberry-pi-vc/C/populate.sh
;; /home/pi/ccl/arm-headers/raspberry-pi-vc/objc-methods.cdb
;; /home/pi/ccl/arm-headers/raspberry-pi-vc/types.cdb
;; /home/pi/ccl/arm-headers/raspberry-pi-vc/constants.cdb
;; /home/pi/ccl/arm-headers/raspberry-pi-vc/functions.cdb
;; /home/pi/ccl/arm-headers/raspberry-pi-vc/objc-classes.cdb
;; pi@raspberrypi ~/raspberry-pi-egl-test $ du -sh ~/ccl/arm-headers/raspberry-pi-vc/
;; 1.9M    /home/pi/ccl/arm-headers/raspberry-pi-vc/
